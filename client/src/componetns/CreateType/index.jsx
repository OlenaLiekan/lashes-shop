        ...
        <div className={styles.createType}>
            ...
            <form onSubmit={pushType} className={styles.formType}>
                ...
                <div className={styles.line}>
                    ...
                    <div id="type-category" required tabIndex="5" className={styles.formSelect} onClick={toggleOptions}>
                        {categoryName}
                ...
                <div className={styles.line}>
                    ...
                    <input id="type-file" required tabIndex="6" type='file' className={styles.formFile}
                        onChange={selectFile}
                    />                    
                </div>
                <button type='submit' tabIndex='13' className={styles.button}>Create type</button>
            </form>            
        </div>
