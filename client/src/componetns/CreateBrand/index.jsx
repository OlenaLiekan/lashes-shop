...
const CreateBrand = () => {
    ...
    return (
        <div className={styles.createBrand}>
            ...
            <form className={styles.formBrand}>
                <div className={styles.line}>
                    <label htmlFor="brand-name" className={styles.label} placeholder='Name'>Name:</label>
                    <input id="brand-name" required tabIndex="1" type='text' className={styles.formInput}></input>                    
                </div>
                <div className={styles.line}>
                    <label htmlFor="brand-file" className={styles.label}>Image:</label>
                    <input id="brand-file" required tabIndex="6" type='file' className={styles.formFile}></input>                    
                </div>
                <button type='submit' onSubmit={pushBrand} tabIndex='13' className={styles.button}>Create brand</button>
            </form>            
        </div>
    );
};
