...
const ProductBlock = ({path, id, info, name, typeId, subtitle, price, brandId, img, thickness, lengthP, volume, imageSlides}) => {
        ...
        <div className="product-main__item item-product">
            <div className="item-product__body">
                <div className={isAuth && adminMode ? 'item-product__actions' : 'item-product__actions_hidden'}>
                    ...
                    <svg className='update-product' onClick={() => updateProductOn(id)} xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512">
